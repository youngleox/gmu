...
class NonLocal(nn.Module):
    ...
    def __init__(self, in_dim):
        ...
        if sn_flag:
            ...
            print("Self attention spectral norm ablated")
            self.theta = (nn.Conv2d(in_dim, in_dim // 8, 1, 1, 0))
            self.phi = (nn.Conv2d(in_dim, in_dim // 8, 1, 1, 0))
            self.g = (nn.Conv2d(in_dim, in_dim // 2, 1, 1, 0))
            self.out_conv = (nn.Conv2d(in_dim // 2, in_dim, 1, 1, 0))
        self.gamma = 1.0
